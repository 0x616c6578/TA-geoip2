            ...
            if city_reader:
                ...
                try:
                    ...
                    city_fields = {
                        ...
                        'location.latitude': response.location.latitude if response else self.fillnull,
                        'location.longitude': response.location.longitude if response else self.fillnull,
